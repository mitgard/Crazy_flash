...
public class FlashlightController {
    ...
    private void dispatchListeners(int message, boolean argument) {
        synchronized (mListeners) {
            ...
            for (WeakReference<FlashlightListener> mListener : mListeners) {
                FlashlightListener l = mListener.get();
                if (l != null) {
    ...
    CameraDevice.StateCallback mCameraListener = new CameraDevice.StateCallback() {
        @Override
